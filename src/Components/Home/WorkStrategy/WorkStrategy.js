...
export function WorkStrategy() {
  return (
    <div
      id="work"
      className="work text-c3 m-5 mt-10 md:m-16 text-lg "
    >
      <div>
        <span className="text-left font-medium">How do I work</span>
        <br></br>
        <span className="text-left text-c3 text-3xl font-semibold">
          Development Process
        </span>
      </div>
      <div className="md:columns-2 columns-1">
        <div className="flex flex-col strategy1 md:p-5">
          <div className="flex mt-5">
            <GiArchiveResearch className="self-center bg-black bg-opacity-50 p-1 rounded-md w-11 h-11" />
            <span className="self-center ml-2 text-xl">
              Research & Strategy
            </span>
          </div>

          <div className="font-sans text-sm mt-2 md:text-lg">
        ...
        <div className="flex flex-col strategy2 md:p-5">
          <div className="flex mt-5">
            <HiLightBulb className="self-center bg-black bg-opacity-50 p-1 rounded-md w-11 h-11" />
            <span className="self-center ml-2 text-xl">
        ...
        <div className="flex flex-col strategy3 md:p-5">
          <div className="flex mt-5">
            <HiOutlineCode className="self-center bg-black bg-opacity-50 p-1 rounded-md w-11 h-11" />
        ...
        <div className="flex flex-col strategy4 md:p-5">
          <div className="flex mt-5">
            <HiShieldCheck className="self-center bg-black bg-opacity-50 p-1 rounded-md w-11 h-11" />
