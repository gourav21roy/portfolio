...
export function Footer() {
  return (
    <div className="flex flex-col text-body text-c3  bg-black bg-opacity-40">
      <div className="flex flex-col md:m-16 m-5">
        ...
        <div className="flex flex-row gap-3 self-center m-4">
          <a href="https://www.linkedin.com/in/gourav21roy" target="_blank" rel="noreferrer">
            <SiLinkedin className="w-8 h-8 hover:bg-blue-700"  />
          </a>
          <a href="https://www.github.com/gourav21roy" target="_blank" rel="noreferrer">
            <SiGithub className="w-8 h-8 hover:bg-black hover:rounded-3xl" />
          </a>
          <a href="https://auth.geeksforgeeks.org/user/gourav21roy" target="_blank" rel="noreferrer">
            <SiGeeksforgeeks className="w-8 h-8 hover:bg-green-600 hover:rounded-3xl p-1" />
          </a>
        </div>
      </div>
    </div>
